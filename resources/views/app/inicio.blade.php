        ...
        <div class="">
            <section class="overflow-hidden ">
                ...
                <div class="content-boxed">
                    <div class="text-xs-center content content-full portada">
                        ...
                        <h2 class="h3 text-white-op push content-boxed ">Contapp es un software de punto de venta,
                                                                         gestión de inventario, cuadre de caja, Informes y
                                                                         mucho más, que ayudará a
                                                                         administrar fácilmente y hacer crecer su
                                                                         negocio.</h2>
