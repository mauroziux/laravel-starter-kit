...
@section('contenido')
    <main id="main-container ">
                ...
                <div class="portada row flex-items-xs-middle">
                    <div class="col-lg-6 col-sm ">
                        <div class="text-xs-center text-md-left">
                            <h1 class="h1 rw-words rw-words-1 typer font-s48 font-w600 text-white text-uppercase">Laboratorio de <br>
        ...
        <!-- seccion 2 -->
        <div id="section-2" class="row flex-items-xs-middle content content-full div-full bg-white">
            <div class="col-sm-12 text-xs-center">
                <p class="h1 text-uppercase font-w700">Esto es lo que hacemos bien</p>
            </div>
            <div class="row col-sm-12 ">
                <div class="col-sm-6 col-lg text-xs-center">
                    <a class="block block-sombra" href="#">
                        <div class="bg-image"
                            ...
                            <div class="bg-black-op">
                                <div class="block-content block-content-full text-center">
                                    <h3 class="h3 text-uppercase text-white push-50-t push-50">Desarrollo <br>web</h3>
                                </div>
                            </div>
                        </div>
                        <div class="block-content block-content-full">
                            <div class="row text-center">
                                <div class="col-xs-12">
                                    <div class="h4 text-muted push-5-t">Creamos aplicacion web únicas para cada uno de nuestros clientes</div>
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-sm-6 col-lg text-xs-center">
                    <a class="block block-sombra" href="#">
                        <div class="bg-image"
                            ...
                            <div class="bg-black-op">
                                <div class="block-content block-content-full text-center">
                                    <h3 class="h3 text-uppercase text-white push-50-t push-50">UI/UX <br>Design</h3>
                                </div>
                            </div>
                        </div>
                        <div class="block-content block-content-full">
                ...
                <div class="col-sm-6 col-lg text-xs-center">
                    <a class="block block-sombra" href="#">
                        <div class="bg-image"
                            ...
                            <div class="bg-black-op">
                                <div class="block-content block-content-full text-center">
                                    <h3 class="h3 text-uppercase text-white push-50-t push-50">Optimización <br>web</h3>
                                </div>
                            </div>
                        </div>
                        <div class="block-content block-content-full">
                ...
                <div class="col-sm-6 col-lg text-xs-center">
                    <a class="block block-sombra" href="#">
                        <div class="bg-image"
                            ...
                            <div class="bg-black-op">
                                <div class="block-content block-content-full text-center">
                                    <h3 class="h3 text-uppercase text-white push-50-t push-50">Pruebas de <br> Usabilidad</h3>
                                </div>
                            </div>
                        </div>
                        <div class="block-content block-content-full">
            ...
            <div class="row col-sm-12 flex-items-xs-center">
